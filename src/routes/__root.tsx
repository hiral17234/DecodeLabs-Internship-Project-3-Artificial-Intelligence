...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "AI-Powered Intelligent Tourism & Travel Companion. Discover India's 28 states through personalized recommendations." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "NavYatra — Know Your India" },
      { name: "twitter:description", content: "AI-Powered Intelligent Tourism & Travel Companion. Discover India's 28 states through personalized recommendations." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/a08fd878-fe4a-4d3b-961b-99fb8bfbe729/id-preview-109b55a6--9acc8957-0e6a-4bf4-b539-70cee522276f.lovable.app-1783592817482.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/a08fd878-fe4a-4d3b-961b-99fb8bfbe729/id-preview-109b55a6--9acc8957-0e6a-4bf4-b539-70cee522276f.lovable.app-1783592817482.png" },
    ],
    links: [
