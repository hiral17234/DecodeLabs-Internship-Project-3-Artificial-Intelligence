...
Below is an exhaustive reference document about the NavYatra web app. Feed this straight into your bot's knowledge base.
...
Approve this plan and I'll save the document as `PROJECT_OVERVIEW.md` in the repo so your bot can ingest it directly (or tell me a different filename / format — JSON, plain txt, etc.).
